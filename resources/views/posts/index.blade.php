                            ...
                            @forelse ($posts as $post)
                                <div class="flex flex-col col-span-12 xl:col-span-4 md:col-span-6 mb-5 space-y-3 relative">
                                    ...
                                    <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0 absolute top-full">
                                        ...
                                        <div class="ml-3 inline-flex rounded-md shadow h-8">
                                            <a href="{{ route('post.delete', ['id' => $post->id]) }}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-indigo-50">
                                              Trash
                                            </a>
                                          </div>
                                      </div>
