                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('post.update', ['id' => $post->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="w-full rounded-md" type="text" name="title" id="title" value="{{ $post->title }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full" name="content" id="content" cols="30" rows="10">{{ $post->content }}</textarea>
